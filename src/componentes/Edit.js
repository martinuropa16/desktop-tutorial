...
const Edit = () => {
  ...
  let activeOption = <option value="Active">Active</option>;
  let inActiveOption = <option value="Inactive">Inactive</option>;
  ...
  const handlesubmit = (e) => {
    ...
    e.preventDefault();
    const empdata = { id, name, email, phone, completed, active, date };
